	...
	*/
	...
	<div class="row">
		...
		<form class="col-lg-6 col-lg-offset-2 form-horizontal" method="post" action="index.php?project=<?php echo $project;?>">
			...
			<div class="row form-group">
				<label class="col-lg-6 control-label">Date begin</label>
				<input class="col-lg-3" type="date" name="dateBegin" required="required" />
				<input class="col-lg-3" type="time" name="timeBegin" required="required" />
			</div>

			<div class="row form-group">
				<label class="col-lg-6 control-label">Date end</label>
				<input class="col-lg-3" type="date" name="dateEnd" required="required" />
				<input class="col-lg-3" type="time" name="timeEnd" required="required" />
			</div>
